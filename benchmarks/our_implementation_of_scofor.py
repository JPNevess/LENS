"""Co-training by disagreement inside a single forest.
...
disagree, and the agreeing fraction clears the admission threshold.

Random feature subspaces give the members the different views that co-training
assumes, without needing a genuine multi-view dataset.
...
class StreamingCoForest(LENS):
    """Uniform vote; this method acts only through how members teach each other."""
